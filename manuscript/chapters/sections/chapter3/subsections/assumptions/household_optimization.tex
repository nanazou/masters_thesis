...
および外国通貨建てリスクフリー債券\(b_{t+1}^{h\to F}\)を最適化する機会を得る。
...
\begin{itemize}
    ...
    \label{itm:household_optimization_home_calculation_remark1}
        ...
        \begin{itemize}
            ...
            \item 前期から持ち越した外国通貨建てリスクフリー債券\(b_t^{h\to F}\)
    ...
    \label{itm:household_optimization_home_calculation_remark2}
        ...
        \begin{itemize}
            ...
            \item 外国通貨建てリスクフリー債券\(b_{t+1}^{h\to F}\)
        \end{itemize}
\end{itemize}
...
および自国通貨建てリスクフリー債券\(b_{t+1}^{f\to H*}\)を最適化する機会を得る。
...
\begin{itemize}
    ...
    \label{itm:household_optimization_foreign_calculation_remark1}
        ...
        \begin{itemize}
            ...
            \item 前期から持ち越した自国通貨建てリスクフリー債券\(b_t^{f\to H*}\)
    ...
    \label{itm:household_optimization_foreign_calculation_remark2}
        ...
        \begin{itemize}
            ...
            \item 自国通貨建てリスクフリー債券\(b_{t+1}^{f\to H*}\)
        \end{itemize}
\end{itemize}