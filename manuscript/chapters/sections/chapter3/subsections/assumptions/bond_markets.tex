% !TeX root = ../../../../../main.tex
% sections/chapter3/subsections/assumptions/bond_markets.tex
...
\label{sec:chapter3_assumptions_bond_markets_home}

\paragraph{自国コンティンジェント債券市場の参加者}
\label{sec:chapter3_assumptions_bond_markets_home_participants}
自国コンティンジェント債券市場の参加者は自国家計のみである。

\paragraph{自国コンティンジェント債券市場の債券}
\label{sec:chapter3_assumptions_bond_markets_home_bonds}
...
（\ref{sec:chapter3_assumptions_chapter3_risk_sharing_commonization_home}節）。
自国コンティンジェント債券\(d_{t+1}^{h\to H}(j)\)の価格を\(q_{t,t+1}(j)\)とする。

\paragraph{自国コンティンジェント債券市場の均衡}
\label{sec:chapter3_assumptions_bond_markets_home_equilibrium}
任意の\(j\in J\)について
自国コンティンジェント債券\(d_{t+1}^{h\to H}(j)\)のすべての自国家計\(h\)についての和は0になる。
\begin{equation}
\label{form:chapter3_assumptions_bond_markets_home_equilibrium}
    \sum_{h\in H}d_{t+1}^{h\to H}(j)=0 \quad (\forall t\ge s, \forall j\in J)
\end{equation}

\subsubsection{外国コンティンジェント債券市場}
\label{sec:chapter3_assumptions_bond_markets_foreign}

\paragraph{外国コンティンジェント債券市場の参加者}
\label{sec:chapter3_assumptions_bond_markets_foreign_participants}
外国コンティンジェント債券市場の参加者は外国家計のみである。

\paragraph{外国コンティンジェント債券市場の債券}
\label{sec:chapter3_assumptions_bond_markets_foreign_bonds}
...
（\ref{sec:chapter3_assumptions_chapter3_risk_sharing_commonization_foreign}節）。
...
\label{sec:chapter3_assumptions_bond_markets_foreign_equilibrium}
任意の\(j\in J\)について
外国コンティンジェント債券\(d_{t+1}^{f\to F*}(j)\)のすべての外国家計\(f\)についての和は0になる。
\begin{equation}
\label{form:chapter3_assumptions_bond_markets_foreign_equilibrium}
...
\label{sec:chapter3_assumptions_bond_markets_international_participants}
国際リスクフリー債券市場の参加者は自国家計および外国家計である。

\paragraph{国際リスクフリー債券市場の債券}
\label{sec:chapter3_assumptions_bond_markets_international_bonds}
...
\label{sec:chapter3_assumptions_bond_markets_international_equilibrium}
...
\begin{equation}
\label{form:chapter3_assumptions_bond_markets_international_equilibrium}
