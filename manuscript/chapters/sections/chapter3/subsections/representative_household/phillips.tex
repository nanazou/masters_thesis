...
\begin{align}
    \label{form:chapter3_representative_household_phillips_home_representative_p_H_tilde_def}
...
\begin{equation}
\label{form:chapter3_representative_household_phillips_home_representative_p_H_bar_dynamics_p_H_bar_modified_eq}
    (\bar{p}_t^H)^{1-\theta^H}
    =\frac{1}{N}
...
これにより第1項は以下のようになる。
\begin{equation}
\label{form:chapter3_representative_household_phillips_home_representative_p_H_bar_dynamics_p_H_bar_modified_first_term_eq}
...
\begin{equation}
\label{form:chapter3_representative_household_phillips_home_representative_p_H_bar_dynamics_p_H_bar_modified_second_term_eq}
    \sum_{q\in Q_t^H} (p_{t-1}^q)^{1-\theta^H}
    =\xi^H \sum_{h\in H} (p_{t-1}^h)^{1-\theta^H}
    =\xi^H N(\bar{p}_{t-1}^H)^{1-\theta^H}
\end{equation}
これを式
\eqref{form:chapter3_representative_household_phillips_home_representative_p_H_bar_dynamics_p_H_bar_modified_eq}
に代入すると以下が得られる。
\begin{equation}
\label{form:chapter3_representative_household_phillips_home_representative_p_H_bar_dynamics_p_H_bar_modified2_eq}
    (\bar{p}_t^H)^{1-\theta^H}
    =\frac{1}{N}
...
は以下のように書き換えられることがわかる。
\begin{equation}
\label{form:chapter3_representative_household_phillips_home_representative_Delta_H_dynamics_Delta_H_modified_eq}
    \Delta_t^H
...
これにより第1項は以下のようになる。
\begin{equation}
\label{form:chapter3_representative_household_phillips_home_representative_Delta_H_dynamics_Delta_H_modified_first_term_eq}
...
これらを合わせると第2項は以下のように計算される。
\begin{equation}
\label{form:chapter3_representative_household_phillips_home_representative_Delta_H_dynamics_Delta_H_modified_second_term_eq}
...
\end{equation}
これを式
\eqref{form:chapter3_representative_household_phillips_home_representative_Delta_H_dynamics_Delta_H_modified_eq}
に代入すると以下が得られる。
\begin{equation}
\label{form:chapter3_representative_household_phillips_home_representative_Delta_H_dynamics_Delta_H_modified2_eq}
    \Delta_t^H
...
\begin{align}
    \label{form:chapter3_representative_household_phillips_foreign_representative_p_F_tilde_def}
...
は以下のように書き換えられることがわかる。
\begin{equation}
\label{form:chapter3_representative_household_phillips_foreign_representative_p_F_bar_dynamics_p_F_bar_modified_eq}
    (\bar{p}_t^{F*})^{1-\theta^F}
    =\frac{1}{M}
...
ここで右辺括弧内の第1,2項の変形を考える。
まず第1項について、定義式
\eqref{form:chapter3_representative_household_phillips_foreign_representative_p_F_tilde_def}
により、すべての\(r\in R_t^F\)について\(p_t^{r*}=\widetilde{p}_t^{F*}\)である。
また\(R_t^F\)の大きさは\((1-\xi^F)M\)により近似される。
これにより第1項は以下のようになる。
\begin{equation}
\label{form:chapter3_representative_household_phillips_foreign_representative_p_F_bar_dynamics_p_F_bar_modified_first_term_eq}
...
これらを合わせると第2項は以下のように計算される。
\begin{equation}
\label{form:chapter3_representative_household_phillips_foreign_representative_p_F_bar_dynamics_p_F_bar_modified_second_term_eq}
    \sum_{q\in Q_t^F} (p_{t-1}^{q*})^{1-\theta^F}
    =\xi^F \sum_{f\in F} (p_{t-1}^{f*})^{1-\theta^F}
    =\xi^F M(\bar{p}_{t-1}^{F*})^{1-\theta^F}
\end{equation}
これを式
\eqref{form:chapter3_representative_household_phillips_foreign_representative_p_F_bar_dynamics_p_F_bar_modified_eq}
に代入すると以下が得られる。
\begin{equation}
\label{form:chapter3_representative_household_phillips_foreign_representative_p_F_bar_dynamics_p_F_bar_modified2_eq}
    (\bar{p}_t^{F*})^{1-\theta^F}
    =\frac{1}{M}
...
は以下のように書き換えられることがわかる。
\begin{equation}
\label{form:chapter3_representative_household_phillips_foreign_representative_Delta_F_dynamics_Delta_F_modified_eq}
    \Delta_t^F
...
これにより第1項は以下のようになる。
\begin{equation}
\label{form:chapter3_representative_household_phillips_foreign_representative_Delta_F_dynamics_Delta_F_modified_first_term_eq}
...
これらを合わせると第2項は以下のように計算される。
\begin{equation}
\label{form:chapter3_representative_household_phillips_foreign_representative_Delta_F_dynamics_Delta_F_modified_second_term_eq}
...
\end{equation}
これを式
\eqref{form:chapter3_representative_household_phillips_foreign_representative_Delta_F_dynamics_Delta_F_modified_eq}
に代入すると以下が得られる。
\begin{equation}
\label{form:chapter3_representative_household_phillips_foreign_representative_Delta_F_dynamics_Delta_F_modified2_eq}
    \Delta_t^F
