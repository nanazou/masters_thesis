% !TeX root = ../../../../../main.tex
% sections/chapter3/subsections/parameters.tex
...
本稿では第5章において様々な自国金融政策のパフォーマンスを比較する。
...
この非対称な設定は、第5章で詳述する本モデル特有の「遮断効果」によって正当化される。
...
以上の前提の下で探索された最適値であり、
これらを用いておこなったシミュレーション結果が\eqref{chap:chapter5}章で示される。