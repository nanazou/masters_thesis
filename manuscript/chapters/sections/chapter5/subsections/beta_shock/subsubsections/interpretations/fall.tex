% !TeX root = ../../../../../main.tex
% chapters/sections/chapter5/subsections/beta_shock/subsubsections/interpretations/fall.tex

\subsubsection{\(i_t^H\)が下落する政策群（すべての政策）の解釈}
\label{sec:chapter5_a_shock_interpretations_fall}
\begin{enumerate}
    \item
    \label{itm:chapter5_beta_shock_interpretations_fall_first}
        \textbf{1期：\(\beta\)ショックの発生と波及}
        \begin{description}[style=nextline]
            \item[\(\beta_1^H\)の\(1\)を超えての上昇と\(i_1^H\)の\(0\)への下落]
            \label{itm:chapter5_beta_shock_interpretations_fall_first_beta_H}
            ...
            \label{itm:chapter5_beta_shock_interpretations_fall_first_beta_H_YD_CD}
            ...
            \label{itm:chapter5_beta_shock_interpretations_fall_first_i_H_YD_CD}
            ...
            \label{itm:chapter5_beta_shock_interpretations_fall_first_E_lambda_YD_CD}
            ...
            \item[\(\hat{p}_0^H+\beta_{ss}^H\operatorname{E}_1[\hat{\pi}_2^H]\)が負になったことによるYS-\(\hat{p}\),CS-\(\hat{p}\)曲線の右下移動]
            \label{itm:chapter5_beta_shock_interpretations_fall_first_y_H_YS_CS}
                このとき供給側においても変化が生じる。
                まずYS-\(\hat{p}\),CS-\(\hat{p}\)曲線の切片は主に
                \(\hat{p}_0^H+\beta_{ss}^H\operatorname{E}_1[\hat{\pi}_2^H]\)
                によって決まることに注意する。
                ここまでの合計として\(p_1^H\)は減少するため\(\hat{p}_1^H\)が負である。
                そのため\(\hat{\pi}_1^H=\hat{p}_1^H-\hat{p}_0^H=\hat{p}_1^H\)が負であるから、
                \(\operatorname{E}_1[\hat{\pi}_2^H]\)も負であるとする。
                するとYS-\(\hat{p}\),CS-\(\hat{p}\)曲線は右辺において\(\hat{p}_0^H=0\)のため
                切片は主に\(\operatorname{E}_1[\hat{\pi}_2^H]\)によって決まる。
                この\(\operatorname{E}_1[\hat{\pi}_2^H]\)は負であると仮定しており、
                さらにこの影響で切片も負になったとすると、
                YS-\(\hat{p}\),CS-\(\hat{p}\)曲線は右下に移動する。
                これにより\(y_1^H,c_1^{H\to W}\)は増加し、\(p_1^H,p_1^{H\to W}\)は減少する。
            \item[1期のまとめ]
            \label{itm:chapter5_beta_shock_interpretations_fall_first_summary}
        ...
        \end{description}
    \item
    \label{itm:chapter5_beta_shock_interpretations_fall_second}
        \textbf{2期から山の頂点まで}
        \begin{description}[style=nextline]
            \item[\(\hat{y}_1^H\)が負になったことによるYS-\(\hat{p}\),CS-\(\hat{p}\)曲線の左上への圧力]
            \label{itm:chapter5_beta_shock_interpretations_fall_second_y_H_YS_CS}
            ...
            \label{itm:chapter5_beta_shock_interpretations_fall_second_beta_H_i_H}
                \(\beta_t^H\)は自己回帰過程の式
                \eqref{form:chapter4_shocks_beta_eq}
                にしたがい\(1\)へ向かって減少する。
                \(i_t^H\)は引き続き\(0\)に保たれる。
            \item[\(1<\beta_t^H\)の減少と\(i_t^H=0\)の継続によるYD,CD曲線の右上移動]
            \label{itm:chapter5_beta_shock_interpretations_fall_second_beta_H_i_H_YD_CD}
            ...
            \label{itm:chapter5_beta_shock_interpretations_fall_second_beta_H_i_H_YD_CD_2}
            ...
            \label{itm:chapter5_beta_shock_interpretations_fall_second_E_lambda_YD_CD}
                自国コンティンジェント債券に関する前方展開されたオイラー方程式
                \eqref{form:chapter5_beta_shock_policies_overview_euler_contingent_lim}
            ...
            \label{itm:chapter5_beta_shock_interpretations_fall_second_y_H_YS_CS_2}
                このとき供給側においても変化が生じる。
            ...
            \item[2期から山の頂点までのまとめ]
            \label{itm:chapter5_beta_shock_interpretations_fall_second_summary}
        ...
        \end{description}
    \item
    \label{itm:chapter5_beta_shock_interpretations_fall_third}
        \textbf{山の頂点から山が終わるまで}
        \begin{description}[style=nextline]
            \item[\(1>\beta_t^H\)の減少と目標達成後の\(i_t^H=0\)の継続]
            \label{itm:chapter5_beta_shock_interpretations_fall_third_beta_H_i_H}
                \(\beta_t^H\)は自己回帰過程の式
                \eqref{form:chapter4_shocks_beta_eq}
                にしたがい\(1\)から\(\beta_{ss}^H\)へ向かって減少する。
                \(i_t^H\)は引き続き\(\gamma_t^H\)が負であることにより\(0\)に保たれる。
            \item[\(1>\beta_t^H\)の減少と\(i_t^H=0\)の継続によるYD,CD曲線の右上移動]
            \label{itm:chapter5_beta_shock_interpretations_fall_third_beta_H_i_H_YD_CD}
                引き続き\(i_t^H\)は\(0\)のままで\(\beta_t^H\)が減少していくため
                YD,CD曲線は右上へ移動していく。
                これにより引き続き\(y_t^H,c_t^{H\to W}\)および\(p_t^H,p_t^{H\to W}\)が上昇していく。
            \item[\(\operatorname{E}_t[\lambda_{t+1}^H]\)の上昇によるYD,CD曲線の左下移動]
            \label{itm:chapter5_beta_shock_interpretations_fall_third_E_lambda_YD_CD}
                自国コンティンジェント債券に関する前方展開されたオイラー方程式
                \eqref{form:chapter5_beta_shock_policies_overview_euler_contingent_lim}
                より、1期進んだときに
                \(\operatorname{E}_t[\lambda_{t+1}^H]\)がどのように変化するかは右辺の無限乗積
            ...
            \label{itm:chapter5_beta_shock_interpretations_fall_third_y_H_YS_CS_3}
                このとき供給側においても変化が生じる。
            ...
            \label{itm:chapter5_beta_shock_interpretations_fall_third_summary}
                \(1>\beta_t^H\)の減少と\(i_t^H=0\)の継続によるYD,CD曲線の右上移動
        ...
        \end{description}
    \item
    \label{itm:chapter5_beta_shock_interpretations_fall_fourth}
        \textbf{定常状態への収束}
        \begin{description}[style=nextline]
            \item[\(1>\beta_t^H\)と\(0<i_t^H\)の初期定常状態への収束]
            \label{itm:chapter5_beta_shock_interpretations_fall_fourth_beta_H_i_H}
            ...
            \label{itm:chapter5_beta_shock_interpretations_fall_fourth_beta_H_i_H_YD_CD}
            ...
            \label{itm:chapter5_beta_shock_interpretations_fall_fourth_E_lambda_YD_CD}
                自国コンティンジェント債券に関する前方展開されたオイラー方程式
                \eqref{form:chapter5_beta_shock_policies_overview_euler_contingent_lim}
                より、1期進んだときに
                \(\operatorname{E}_t[\lambda_{t+1}^H]\)がどのように変化するかは右辺の無限乗積
            ...
            \label{itm:chapter5_beta_shock_interpretations_fall_fourth_y_H_YS_CS}
                このとき供給側においても変化が生じる。
                \(\hat{y}_t^H\)は\(0\)へ向かって収束する。
                そのためYS-\(\hat{p}\),CS-\(\hat{p}\)曲線は移動を停止する。
                これにより\(y_t^H,c_t^{H\to W}\)および\(p_t^H,p_t^{H\to W}\)も移動を停止する。
            \item[定常状態への収束のまとめ]
            \label{itm:chapter5_beta_shock_interpretations_fall_fourth_summary}
