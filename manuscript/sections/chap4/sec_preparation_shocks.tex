...
\section{ショックの設定}
\label{sec:model_preparation_shocks}
...
\end{aligned}
\label{form:model_preparation_shocks_stochastic_processes}
\end{equation}
自己回帰係数についてはパラメータ設定の表\ref{tab:model_preparation_parameters_list}でも示したとおり
