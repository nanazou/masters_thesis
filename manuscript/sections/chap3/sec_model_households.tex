...
\subsection{価格以外の最適化}
\label{sec:model_optimization_except_price}
...
\label{sec:model_consumption_baskets}
...
\label{subsec:model_consumption_stage1a}
...
\label{subsec:model_consumption_stage1b}
...
\end{aligned}
\label{eq:home_lagrangian_modified}
\end{equation}
