% !TeX root = ../../main.tex
% app/appendix_insulation_effect.tex
...
\label{sec:appendix_insulation_effect_core_equations}

まず、外国の主要な内生変数を決定するコア方程式系を導出する。

\paragraph{1. 外国財市場の均衡式}
\label{sec:appendix_insulation_effect_foreign_market_clearing}
...
\label{sec:appendix_insulation_effect_foreign_euler}
...
\label{sec:appendix_insulation_effect_foreign_phillips}
...
\label{sec:appendix_insulation_effect_foreign_policy}
...
\label{sec:appendix_insulation_effect_modified_uip}
...
\label{sec:appendix_insulation_effect_other_vars}
上記で決定された9つの外国関連変数
\( \{ \lambda_t^{H/*}, \lambda_t^{F/*}, p_t^{F*}, i_t^F,
 \widetilde{p}_t^{F*}, v_t^F, w_t^F, y_t^F, \Delta_t^F \} \)
...
\label{sec:appendix_insulation_effect_home_consumption_HF}
...
\label{sec:appendix_insulation_effect_foreign_consumption_FF}
...
\label{sec:appendix_insulation_effect_foreign_labor}
...
\label{sec:appendix_insulation_effect_foreign_ppi_normalized}
...
\label{sec:appendix_insulation_effect_foreign_inflation}
...
\label{sec:appendix_insulation_effect_foreign_transfer}
...
\label{sec:appendix_insulation_effect_home_net_assets}
