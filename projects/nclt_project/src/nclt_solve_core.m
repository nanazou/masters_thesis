function [welfares, irf_results, Mbase_, oobase_] = nclt_solve_core(phi_gap_H_value, phi_level_H_value, settings)

% src/nclt_solve_core.m
% =========================================================================
...
modnam = settings.modnam;         % 'nclt_model'
modnamstar = settings.modnamstar; % 'nclt_model_zlb'
...
% 結果をワークスペースの変数に展開
% (pi_H_W, pi_F_W_star 等も自動的に展開される)
