function [welfares, irf_results, Mbase_, oobase_] = clt_solve_core(phi_gap_H_value, phi_level_H_value, settings)

% src/clt_solve_core.m
% =========================================================================
...
% 結果をワークスペースの変数に展開
% (前のループの変数が混ざらないよう上書き)
% ここで pi_F_W_star も自動的に pi_F_W_star_pie / pi_F_W_star_lin として展開される
