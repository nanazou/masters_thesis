function [welfares, irf_results, Mbase_, oobase_] = ngdplt_solve_core(phi_gap_H_value, phi_level_H_value, settings)

% src/ngdplt_solve_core.m
% =========================================================================
% Solver実行、変数展開、Welfare計算 (NGDPLT用)
% =========================================================================
...
modnam = settings.modnam;         % 'ngdplt_model'
modnamstar = settings.modnamstar; % 'ngdplt_model_zlb'
...
for t = 1:nperiods
    ...
    % Delta_H の更新: Δ_t = ξΔ_{t-1} + 0.5 * (θξ/(1-ξ)) * π_t^2
