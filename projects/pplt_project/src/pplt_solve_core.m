function [welfares, irf_results, Mbase_, oobase_] = pplt_solve_core(phi_gap_H_value, phi_level_H_value, settings)

% src/pplt_solve_core.m
% =========================================================================
% Solver実行、変数展開、Welfare計算 (PPLT用)
% =========================================================================
...
modnam = settings.modnam;         % 'pplt_model'
modnamstar = settings.modnamstar; % 'pplt_model_zlb'
