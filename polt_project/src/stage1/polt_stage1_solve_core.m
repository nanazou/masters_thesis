function [welfares, irf_results, Mbase_, oobase_] = polt_stage1_solve_core(phi_gap_H_value, phi_level_H_value, settings)

% src/stage1/polt_stage1_solve_core.m
% =========================================================================
% Stage 1: Flexible Price Model Simulation (Linear)
%
...
% この関数ファイルが存在する場所（project_polt/src/stage1/）のパスを取得
...
% --- [3] モデルの初期化と実行 ---
% settings.modnam = 'polt_stage1_model' を参照
