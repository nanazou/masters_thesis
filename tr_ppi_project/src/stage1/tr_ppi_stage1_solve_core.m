% src/stage1/tr_ppi_stage1_solve_core.m

function [welfares, irf_results, Mbase_, oobase_] = tr_ppi_stage1_solve_core(phi_pi_H_value, phi_pi_F_value, settings)
% =========================================================================
% tr_ppi_stage1_solve_core.m
% Stage 1: Flexible Price Model Simulation (Linear) - TR PPI Project
%
...
% --- [3] モデルの初期化と実行 ---
% settings.modnam = 'tr_ppi_stage1_model' を参照
